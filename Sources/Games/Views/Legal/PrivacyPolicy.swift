        ...
        ScrollView(.vertical, showsIndicators: false) {
            VStack(alignment: .leading) {
                Group {
                    ...
                    The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at \(product) unless otherwise defined in this Privacy Policy.
                    """)
                }.padding()
                Group {
                    Text("Information Collection and Use").font(.title)
                    MultilineText("""
                ...
                Group {
                    Text("Service Providers").font(.title)
                    MultilineText("""
